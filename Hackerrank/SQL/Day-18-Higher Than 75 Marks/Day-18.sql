...
-- who scored higher than  Marks. Order your 
-- output by the last three characters of each name. 
...
-- Here is the **image converted into plain text**:
...
select Name from STUDENTS where Marks>75 order by substr(Name,
Length(Name)-2,3)
,ID asc;
